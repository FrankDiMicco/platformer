...
pf_09 = Platform(-300, -300, 300, 20, 'black')
...
class Moving_Platform(Platform):
    def __init__(self, x, y, width, height, x_speed, y_speed, distance, color=PLATFORM ):
...
mov_plat02 = Moving_Platform(410, 50, 50, 20, 0, 1, 100, 'orange')
mov_plat03 = Moving_Platform(150, -50, 50, 20, 0, 1, 100, 'black')
mov_plat04 = Moving_Platform(75, -240, 50, 20, 0, 2, 100, 'black')
